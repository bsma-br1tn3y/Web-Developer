...
import discord
# local own library
# from nama_file_python lain import nama_fungsi
from bot_logic import gen_pass,coinflip,roll_dice,kata_hari_ini
...
async def on_message(message):
    ...
    elif message.content.startswith('kata'):
        await message.channel.send(f"Kata motivasi hari ini adalah {kata_hari_ini()}")
